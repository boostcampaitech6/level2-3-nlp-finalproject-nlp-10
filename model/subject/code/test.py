...
while(True):
    idx = input(f"Index 입력(최대 {len(target)-1}) :")
    idx = int(idx)
    ...
    print(f"예측 : {remove_space(remove_between_square_brackets(tokenizer.decode(summary_text_ids[0], skip_special_tokens=True)))}")
