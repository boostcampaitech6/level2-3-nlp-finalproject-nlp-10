    ...
    <>
      <Grid sx={{ display: "flex", justifyContent: "center" }}>
        <Box sx={{ width: "75vw", height: "86vh", mt: 4, border: "1px solid #b4b4b4", borderRadius: 4, display: "flex", justifySelf: "center", flexDirection: "column" }}>
          <Box sx={{ position: "absolute", top: "6.5rem", left: "30vw", bgcolor: "white", p: 1 }}><FaQuoteLeft /></Box>
          <Box sx={{ position: "absolute", top: "11rem", left: "66.2vw", bgcolor: "white", p: 1 }}><FaQuoteRight /></Box>
